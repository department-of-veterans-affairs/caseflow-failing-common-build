    ...
    if (env.APP_ENV == 'prod') {
      stage('deploy-message') {
        ...
        DEPLOY_MESSAGE = sh (
          ...
          script: "git log \$(git ls-remote --tags https://${env.GIT_CREDENTIAL}@github.com/department-of-veterans-affairs/caseflow-failing-common-build.git \
